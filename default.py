...
HushamBase = 'https://raw.githubusercontent.com/hmemar/husham.com/master/Lists/solomanlists.xml'

addon = xbmcaddon.Addon('plugin.video.Larcvision’)
